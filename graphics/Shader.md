...
* [渲染路径](#渲染路径)
  ...
  * [前向渲染](#前向渲染)
    * [Base Pass](#base-pass)
    * [Additional Pass](#additional-pass)
    * [可使用的变量和函数](#可使用的变量和函数)
  * [延迟渲染](#延迟渲染)
    * [G缓冲区中默认包含的渲染纹理（Render Texture，RT）](#g缓冲区中默认包含的渲染纹理render-texturert)
    * [可使用的变量和函数](#可使用的变量和函数-1)
  * [光源类型](#光源类型)
    * [不同光源的宏](#不同光源的宏)
  * [光照衰减](#光照衰减)
  * [阴影](#阴影)
    * [Shadow Map](#shadow-map)
    * [Screenspace Shadow Map](#screenspace-shadow-map)
    * [阴影实现](#阴影实现)
